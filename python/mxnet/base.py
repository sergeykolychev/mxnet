...
ProfileDomainHandle = ctypes.c_void_p
ProfileTaskHandle = ctypes.c_void_p
ProfileFrameHandle = ctypes.c_void_p
ProfileEventHandle = ctypes.c_void_p
ProfileCounterHandle = ctypes.c_void_p
#----------------------------
